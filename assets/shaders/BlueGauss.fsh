...
#define Gsmoothing   1.5  	//Default: 3.5 /increase for smoother(blurry) graphics
//================
...
#define samples      0     	//Default: 4 /higher = more glow, worser performance
...
#define value        7.6   	//Default: 7.5 /higher = more visible effect
//================
...
#define saturation   1.7  	//Default: 1.0 //negative will look like inverted colors shader
#define brightness   1.1  	//Default: 1.0
#define contrast     1.1  	//Default: 1.0 //negative will be... well negative;p
#define red          1.1   	//Default: 1.0
#define green        1.3  	//Default: 1.0
...
#define testAspeed   9.0 	//animation speed
//======================================================================================================================================================================
